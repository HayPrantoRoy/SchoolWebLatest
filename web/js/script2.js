...
function loadWordsJQuery() {
    // Load Head Teacher Words and Image
    $.ajax({
        url: 'API/GetFileList.php',
        type: 'GET',
        ...
        success: function(response) {
            if (response.success && response.files.length > 0) {
                ...
                // Set the text
                $('#HeadTeacherWords').text(file.description || 'No message available');
                
                // Set the image
                if (file.file_url) {
                    $('#HeadTeacherImage').attr('src', '../Admin/' + file.file_url);
                }
            } else {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success && response.files.length > 0) {
                ...
                // Set the image
                if (file.file_url) {
                    $('#PresidentImage').attr('src', '../Admin/' + file.file_url);
                }
